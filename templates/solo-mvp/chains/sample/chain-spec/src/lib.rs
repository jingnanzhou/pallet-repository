...
use solo_mvp_sample_runtime::{
	constants::currency::*, wasm_binary_unwrap, AuthorityDiscoveryConfig, BabeConfig,
	BalancesConfig, Block, CouncilConfig,  GrandpaConfig,
...
pub use solo_mvp_sample_runtime::GenesisConfig;
pub use solo_mvp_node_primitives::{AccountId, Balance, Signature};
...
pub fn flaming_fir_config() -> Result<ChainSpec, String> {
	ChainSpec::from_json_bytes(&include_bytes!("../spec_json/flaming-fir.json")[..])
}
...
//	let num_endowed_accounts = endowed_accounts.len();
	...
	GenesisConfig {
		...
		babe: BabeConfig {
			authorities: vec![],
			epoch_config: Some(solo_mvp_sample_runtime::BABE_GENESIS_EPOCH_CONFIG),
		},
